        ...
        <div class="row">
            <div class="col-md-12">
                @if(count($departments) > 0)
                    <a href="{{ route('departments.create') }}" class="btn btn-primary btn-sm my-2">
                                    ...
                                    <tbody>
                                        @foreach($departments as $department)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                         <a class="edit-btn btn btn-info btn-sm fa fa-edit" href="{{ route('departments.show' , $department->id) }}" role="button" style=" margin-right: 5px; ">    Edit  </a>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#deleteModal').on('show.bs.modal', function (event) {
                ...
                var modal = $(this)
                $('#delete-form').attr('action', "departments/"+dept_id);
            })
        });
    </script>
@endsection